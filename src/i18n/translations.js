...
export const translations = {
  en: {
    ...
    contact: {
      ...
      formEmail: "Email",
      formEmailPlaceholder: "you@gmail.com",
      formMessage: "Message",
      ...
      validation: {
        ...
        emailInvalid: "Please use a valid Gmail address (must contain @gmail.com).",
  ...
  ur: {
    ...
    contact: {
      ...
      validation: {
        ...
        emailInvalid: "براہِ کرم درست جی میل ایڈریس استعمال کریں (@gmail.com شامل ہونا ضروری ہے)۔",
